...
const AppContent = () => {
  ...
  useEffect(() => {
    // This effect makes sure auth state is consistent with sessionStorage
  ...
  // Protected route component - defined inline to have access to isAuthenticated and handleLogout
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <Routes>
          ...
          {/* Dashboard Routes - pass the onLogout prop to all protected routes */}
          <Route 
            path="/dashboard" 
            element={
              <ProtectedRoute>
